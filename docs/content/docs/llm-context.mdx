...
Sample size: 10 runs per mode

| Mode | Average | Median | P90 |
| --- | ---: | ---: | ---: |
| TEE no verify | 1843.9 ms | 1835.5 ms | 2014.3 ms |
| No TEE | 1740.0 ms | 1552.0 ms | 1807.1 ms |

Average overhead:
- +103.9 ms
- +5.97%

Note: the No TEE series includes one high-latency outlier at run 3: 3320 ms.
